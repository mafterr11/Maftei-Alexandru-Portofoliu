...
const TabsTrigger = React.forwardRef(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ref={ref}
    className={cn(
      "inline-flex h-[38px] hover:cursor-pointer items-center justify-center whitespace-nowrap  px-3 py-1.5 text-base font-medium ring-offset-accent transition-all focus-visible:outline-dotted focus-visible:ring-2 focus-visible:ring-accent/50 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-accent data-[state=active]:text-white data-[state=active]:shadow-xs",
      className,
    )}
    {...props}
  />
